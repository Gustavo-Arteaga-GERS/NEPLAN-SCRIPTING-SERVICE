...
// string typeAnalysis = "ShortCircuir";
// string faultType = "FaultType";
// string phase = "1";

// función para parametrizar el tipo de análisis

SetCalcParameterAttribute("ShortCircuit", "FaultType", "0");
